...
-- -----------------------------------------------------
-- Table `TranslationInputs_has_Languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `TranslationInputs_has_Languages` ;

CREATE TABLE IF NOT EXISTS `TranslationInputs_has_Languages` (
  `TranslationInputs_idTranslationInputs` INT NOT NULL,
  `Languages_idLanguage` INT NOT NULL,
  PRIMARY KEY (`TranslationInputs_idTranslationInputs`, `Languages_idLanguage`),
  INDEX `fk_TranslationInputs_has_Languages_Languages1_idx` (`Languages_idLanguage` ASC) VISIBLE,
  INDEX `fk_TranslationInputs_has_Languages_TranslationInputs1_idx` (`TranslationInputs_idTranslationInputs` ASC) VISIBLE,
  CONSTRAINT `fk_TranslationInputs_has_Languages_TranslationInputs1`
    FOREIGN KEY (`TranslationInputs_idTranslationInputs`)
    REFERENCES `TranslationInputs` (`idTranslationInput`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TranslationInputs_has_Languages_Languages1`
...
-- -----------------------------------------------------
-- Table `TranslationOutputs_has_TranslationInputs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `TranslationOutputs_has_TranslationInputs` ;

CREATE TABLE IF NOT EXISTS `TranslationOutputs_has_TranslationInputs` (
  `idTranslationOutput` INT NOT NULL,
  `idTranslationInput` INT NOT NULL,
  PRIMARY KEY (`idTranslationOutput`, `idTranslationInput`),
  INDEX `fk_TranslationOutputs_has_TranslationInputs_TranslationInp_idx` (`idTranslationInput` ASC) VISIBLE,
  INDEX `fk_TranslationOutputs_has_TranslationInputs_Translation Ou_idx` (`idTranslationOutput` ASC) VISIBLE,
  CONSTRAINT `fk_TranslationOutputs_has_TranslationInputs_Translation Outp1`
    FOREIGN KEY (`idTranslationOutput`)
    REFERENCES `TranslationOutputs` (`idTranslationOutput`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TranslationOutputs_has_TranslationInputs_TranslationInputs1`
    FOREIGN KEY (`idTranslationInput`)
    REFERENCES `TranslationInputs` (`idTranslationInput`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
