...
import {
  fetchItemTableData,
  headers as itemHeaders,
} from "../data/itemData.js";
import {
  CharacterHeaders,
  fetchCharacterTableData,
} from "../data/charactersData.js";
import {
  fetchGameTableData,
  headers as GameHeaders,
} from "../data/gameData.js";
import {
  fetchLanguageRuleTableData,
  headers as LanguageRuleHeaders,
} from "../data/languageRuleData.js";
import {
  fetchPlayerTableData,
  headers as PlayerHeaders,
} from "../data/playerData.js";
import {
  fetchCountryTableData,
  headers as CountryHeaders,
} from "../data/countryData.js";
import {
  fetchLanguageTableData,
  headers as LanguageHeaders,
} from "../data/languageData.js";
import {
  fetchTranslationsTableData,
  headers as TranslationsHeaders,
} from "../data/translationData.js";
import {
  fetchCHITableData,
  headers as CharacterItemHeaders,
} from "../data/charactersItemsData.js";
import {
  fetchCHLTableData,
  headers as CharacterLanguageHeaders,
} from "../data/charactersLanguagesData.js";
import {
  fetchCoHLTableData,
  headers as CountryLanguageHeaders,
} from "../data/countriesLanguagesData.js";
import {
  fetchLLRTableData,
  headers as LLRHeaders,
} from "../data/languagesLanguageRulesData.js";
...
const DataNext = async (page_determiner, append, purpose, id) => {
  ...
  if (!page_determiner) {
    ...
    const returnedData = await fetchItemTableData(
      itemData,
      append ? append : null,
    ...
    const returnedData = await fetchCharacterTableData(
      characterData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchLanguageRuleTableData(
      languageRuleData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchGameTableData(
      gameData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchPlayerTableData(
      playerData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchCountryTableData(
      countryData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchLanguageTableData(
      languageData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const header_mod = headers;
    const languageData = header_mod.slice(0, headers.length - 2);
    const returnedData = await fetchTranslationsTableData(
      languageData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchCHITableData(
      charItemData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    const returnedData = await fetchCHLTableData(
      charLangData,
      append ? append : null,
      purpose ? purpose : null,
      id
    ...
    return returnedData;
  } else if (page_determiner === "languageslanguagerules") {
    headers = LLRHeaders;
    const header_mod = headers;
    const langRuleData = header_mod.slice(0, headers.length - 2);

    const returnedData = await fetchLLRTableData(
      langRuleData,
      append ? append : null,
      purpose ? purpose : null,
      id
